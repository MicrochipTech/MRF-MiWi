...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-pic18exp_pic16f1947_24j40.mk dist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/881590845/console.p1: ../src/system_config/pic18exp_pic16f1947_24j40/console.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/console.p1 ../src/system_config/pic18exp_pic16f1947_24j40/console.c 
...
${OBJECTDIR}/_ext/881590845/delay.p1: ../src/system_config/pic18exp_pic16f1947_24j40/delay.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/delay.p1 ../src/system_config/pic18exp_pic16f1947_24j40/delay.c 
...
${OBJECTDIR}/_ext/881590845/eeprom.p1: ../src/system_config/pic18exp_pic16f1947_24j40/eeprom.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/eeprom.p1 ../src/system_config/pic18exp_pic16f1947_24j40/eeprom.c 
...
${OBJECTDIR}/_ext/881590845/lcd.p1: ../src/system_config/pic18exp_pic16f1947_24j40/lcd.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/lcd.p1 ../src/system_config/pic18exp_pic16f1947_24j40/lcd.c 
...
${OBJECTDIR}/_ext/881590845/spi.p1: ../src/system_config/pic18exp_pic16f1947_24j40/spi.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/spi.p1 ../src/system_config/pic18exp_pic16f1947_24j40/spi.c 
...
${OBJECTDIR}/_ext/881590845/symbol.p1: ../src/system_config/pic18exp_pic16f1947_24j40/symbol.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/symbol.p1 ../src/system_config/pic18exp_pic16f1947_24j40/symbol.c 
...
${OBJECTDIR}/_ext/881590845/system.p1: ../src/system_config/pic18exp_pic16f1947_24j40/system.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/881590845/system.p1 ../src/system_config/pic18exp_pic16f1947_24j40/system.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=none  -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.map  -DXPRJ_pic18exp_pic16f1947_24j40=$(CND_CONF)    --double=32 --float=32 --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -DPIC16_CONFIG -P -N255 -I"../src/system_config/pic18exp_pic16f1947_24j40" -I"../src" -I"../../src" -I"../../../../../../framework" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/simple_example_star.x.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
